 ...
 *
 * WEBSITE (`lg` and up): the browsing rails, so the list reads at a sensible
 * measure with the rest of the site beside it rather than a phone column in
 * the middle of a monitor.
 */
  ...
  return (
    <div className="flex min-h-dvh flex-col bg-[var(--surface-app)]">
      ...
      <main className="flex flex-1 flex-col">
        <BrowseLayout
          current="questions"
          outerClassName="mx-auto w-full max-w-[42rem] flex-1 pb-16 pt-5 md:px-6 lg:max-w-[76rem] lg:px-10 lg:py-10"
          aside={
            <>
              <RailGroup title="Asking">
                <p className="mt-3 text-[13px] leading-[20px] text-[var(--text-secondary)]">
                  Questions go to other buyers, or to the seller when you pick one. Answers come from people
                ...
                <ul className="mt-3 flex flex-col gap-2 text-[13px]">
                  ...
                  <li>
                    <Link href="/search?tab=questions" className={RAIL_ACTION}>
                      Search questions
                    </Link>
                  </li>
                </ul>
