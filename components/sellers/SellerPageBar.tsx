...
export function SellerPageBar() {
  return (
    ...
    >
      {/* BUG-033: back where the reader came from, not always to the seller
          search. The fallback is that search, for a store link opened cold. */}
      <BackControl
        fallbackHref="/search?tab=sellers"
        label="Back"
